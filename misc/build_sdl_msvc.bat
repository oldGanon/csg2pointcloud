...
set CompilerFlags=-c -MT -nologo -GS- -Gs9999999 -Gm- -GR- -EHa- -Oi -WL -W4 -wd4201 -wd4100 -wd4189 -wd4505 -FC -Z7 -arch:AVX %OptimizationFlag%
set NOCRT=-nodefaultlib kernel32.lib
set LinkerFlags=-nologo -subsystem:windows -stack:0x100000,0x100000 -debug -pdb:sdl_msvc.pdb -out:sdl_msvc.exe -map:sdl_game.map -opt:ref /LIBPATH:"..\lib\x64" %NOCRT% opengl32.lib SDL2.lib SDL2main.lib ws2_32.lib icon.res
